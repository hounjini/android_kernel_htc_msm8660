...
#define  roundup(960 * ALIGN(540, 32) * 3 * 2, 4096)
#else
...
#define MSM_ION_MM_SIZE         0x2C00000		//44M
//#define MSM_ION_SF_SIZE         0x2800000		//Original one. 40M
#define MSM_ION_SF_SIZE		0x48000000		//increased to 64M
#define MSM_ION_WB_SIZE         0x2FD000		//3060K
#define MSM_SMI_ION_SIZE        0x3000000		//48M
...
#define USER_SMI_BASE		(KERNEL_SMI_BASE + KERNEL_SMI_SIZE)		//3c000000
